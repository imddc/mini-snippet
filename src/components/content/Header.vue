...
<template>
  <div data-tauri-drag-region class="flex-between h-[var(--content-header-height)] cursor-pointer p-4">
    <div class="flex items-center gap-2">
      <button
        class="group relative flex size-5 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-red-400 to-pink-400 shadow-lg transition-all duration-300 hover:shadow-xl"
        @click="closeContent"
      >
